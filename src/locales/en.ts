export default {
  ...
  proxy_label_custom_domain: "Custom domain",
  ...
  proxy_ph_custom_domain: "e.g. erp.example.com",
  proxy_remove: "Remove",
  proxy_add: "+ Add proxy",
  ...
  proxy_err_custom_domain: "Proxy #{n} (HTTP/HTTPS) requires a custom domain",
  proxy_err_domain_format: "Proxy #{n} has invalid domain format",
  proxy_hint_http_domain: "HTTP/HTTPS routes via domain — no external port needed.",
  ...
  msg_open_link_failed: "Failed to open link: {err}",
